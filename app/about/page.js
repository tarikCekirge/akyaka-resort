...
const Page = async () => {
  ...
  return (
    <div className='grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center'>
      ...
      <div className='col-span-full md:col-span-2 -order-1 md:order-none relative aspect-square  '>
        <Image
          fill
          placeholder='blur'
          quality={80}
      ...
      <div className='col-span-full md:col-span-2 relative aspect-square  '>
        <Image
          fill
          placeholder='blur'
          quality={80}
          className='w-full object-center object-cover'
          src={aboutTwo}
          alt='Family that manages Akyaka Resort'
        />
      </div>
